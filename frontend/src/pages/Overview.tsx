...
export function Overview({ user, onNavigate }: { user: User; onNavigate: (view: AppView) => void }) {
  ...
  const hourlyTotal = hourly.reduce((sum, point) => sum + point.count, 0);
