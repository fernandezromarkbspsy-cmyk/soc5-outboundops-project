...
export function Overview({ onNavigate }: { user: User; onNavigate: (view: AppView) => void }) {
  ...
  return <div className="workspace-view dashboard-view dashboard-overview">
    ...
    <section className="overview-hero" aria-label="Request metrics overview">
      ...
      <div className="overview-hero-summary-card" aria-label="Primary operational summary">
        <div className="summary-card-head">
          <span className="sync-status">Last updated now</span>
          <span className="summary-card-note">Shift overview</span>
        </div>
      ...
      <article className="panel chart-panel line-panel">
        <div className="panel-head">
          <div>
            ...
            <p>Current night shift, 6 PM to 6 AM</p>
          </div>
