  ...
  return <div className="workspace-view dashboard-view">
    ...
    <section className="overview-hero" aria-label="Request metrics overview">
      <div className="overview-hero-copy">
        ...
        <h1>Dashboard</h1>
        <p>Live logistics health across request intake, dock queue, and fulfilled trips.</p>
      </div>
      <div className="overview-hero-actions" aria-label="Dashboard status">
        <span className="sync-status">Last updated now</span>
        <button className="dashboard-action" type="button" onClick={() => setDetailStatus('ALL')}>Review Requests</button>
        <button className="dashboard-action dashboard-action--primary" type="button" onClick={() => onNavigate('docking')}>Open Docking</button>
      </div>
    </section>
    ...
    <section className="overview-hero-summary" aria-label="Operational health summary">
      <div>
        <span>Peak hour</span>
