...
function ViewLoading({ view }: { view: AppView }) {
  if (view === 'overview') {
    return <div className="workspace-view dashboard-view">
      <section className="overview-hero" aria-hidden="true">
        <div className="overview-hero-copy">
          <span className="skeleton-line skeleton-line--head" style={{ width: 140 }} />
          <span className="skeleton-line" style={{ width: 220, height: 30, marginTop: 12 }} />
          <span className="skeleton-line" style={{ width: 360, marginTop: 12 }} />
        </div>
      ...
      <section className="overview-hero-summary" aria-hidden="true">{Array.from({ length: 3 }).map((_, index) => <div key={index}><span className="skeleton-line skeleton-line--head" style={{ width: 72 }} /><span className="skeleton-line" style={{ width: 110, height: 20 }} /></div>)}</section>
