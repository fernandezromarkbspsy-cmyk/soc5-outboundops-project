...
export interface TruckRequest {id:string;request_timestamp?:string;cluster:string;region:string;dock_no:string;backlogs:number;backlogs_timestamp?:string|null;ob_fte?:string|null;ob_ops_pic?:string|null;midmile_fte?:string|null;doc_officer?:string|null;truck_size:string;truck_type:string;plate_number?:string|null;provide_time?:string|null;linehaul_trip_no?:string|null;docked_time?:string|null;status:Status;rejection_remarks?:string|null;driver_id?:string|null;created_by:string;requested_by?:string|null;created_at:string;updated_at?:string}
