...
export default function App() {
  ...
  useEffect(() => {
    void supabase.auth.getSession()
      ...
      .catch((cause) => {
        setAuthError(cause instanceof Error ? cause.message : 'Unable to read your session.');
        setState('unauthorized');
      });
